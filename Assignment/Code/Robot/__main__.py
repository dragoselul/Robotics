...
if __name__ == "__main__":
    ...
    controller = RobotKinematicsController(robot, verbose=True)
    controller.initialize()
    ...
    # waypoints = []
    # execute_circle_movement(controller, center, radius, num_points=num_points)
    ...
    target_key = [
        ...
        keyboard_center[0],      # x: 0.028m
        keyboard_center[1],      # y: -0.026m  
        keyboard_z               # z: 0.089m (surface height)
    ]
